...
function ConferenceForm(props) {
    ...
    return (
        <div className='input'>
            ...
            <input type="text" value={titleOfThePaper} onChange={changeTitleOfThePaper} />
            <label>Journal/Conferences Details</label>
            <input type="text" value={journalConferencesDetails} onChange={changeJournalConferencesDetails} />
            <label>Year</label>
            <input type="text" value={year} onChange={changeYear} />
            <label>Awards</label>
            <input type="text" value={awards} onChange={changeAwards} />
