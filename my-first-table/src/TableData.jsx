    ...
    return (
        <div className="table-container">
            ...
            <div className="buttons">
                <button className="button1" onClick={handleSortByAsc}>
                    Sort by Year Ascending
                </button>
                <button className="button1" onClick={handleSortByDesc}>
            ...
            <table className="table table-stripped" border="2">
                <thead>
                    <tr>
                        ...
                        <th>National or International Journal conferences details</th>
                        <th>Year</th>
                        <th>Awards</th>
                        {/* <th>Action</th> */}
                        <th>Action</th>
